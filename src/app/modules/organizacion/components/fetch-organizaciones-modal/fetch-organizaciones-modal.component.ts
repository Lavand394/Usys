...
@Component({
  selector: 'app-fetch-organizaciones-modal',
  templateUrl: './fetch-organizaciones-modal.component.html',
  styleUrls: ['./fetch-organizaciones-modal.component.scss']
})
export class FetchOrganizacionesModalComponent implements OnInit, OnDestroy {
  @Input() ids: number[];
  customers: Customer[] = [];
  isLoading = false;
